...
*   **진행 상태:**
    *   [ ] Gemini 또는 Groq API 키 설정 및 환경 변수 관리
    *   [ ] 활동 기록 데이터를 기반으로 AI 프롬프트 구성 로직 구현
    *   [ ] AI API 호출 및 응답 처리 Server Action 또는 API Route 구현
    *   [ ] AI 브리핑 결과를 메인 대시보드 상단 위젯에 표시
    *   [ ] AI 요약 결과에 대한 에러 처리 및 로딩 상태 UI 구현
